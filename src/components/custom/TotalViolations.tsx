...
const chartData = [
  { tab: "Night Drive", value: 50, fill: "#A9A9A9" },
  { tab: "Harsh Acceleration", value: 615, fill: "#ED7864" },
  { tab: "Harsh breaking", value: 610, fill: "#51DDD7" },
  { tab: "Speeding", value: 45, fill: "#1A928C" },
];
...
export function TotalViolations() {
